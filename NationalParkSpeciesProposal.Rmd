...
most_visited_nps_species_data_cleaned <- most_visited_nps_species_data_cleaned %>%
  ...
  select(park_name:family, sci_name, common_names, sensitive, occurrence:abundance, references:vouchers, te_status:s_rank) # removes empty and exluded rows to keep the variables within range
